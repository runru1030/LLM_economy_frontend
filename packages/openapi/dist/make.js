...
`;
export function makeUseQueryString(endpoint, { operationId = "", deprecated = false, }) {
    if (!operationId) {
...
`;
export function makeUseMutationString(method, endpoint, { operationId = "", deprecated = false, }) {
    if (deprecated) {
        return;
    }
    if (!operationId) {
